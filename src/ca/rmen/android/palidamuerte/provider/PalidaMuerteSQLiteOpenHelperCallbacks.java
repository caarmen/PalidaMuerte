 ...
 */
class PalidaMuerteSQLiteOpenHelperCallbacks {
    ...
    void onOpen(final Context context, final SQLiteDatabase db) {
        if (BuildConfig.DEBUG) Log.d(TAG, "onOpen");
        // Insert your db open code here.
    }

    void onPreCreate(final Context context, final SQLiteDatabase db) {
    ...
    void onPostCreate(final Context context, final SQLiteDatabase db) {
    ...
    void onUpgrade(final Context context, final SQLiteDatabase db, final int oldVersion, final int newVersion) {
